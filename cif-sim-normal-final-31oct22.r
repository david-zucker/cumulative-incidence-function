...
#case of normally distributed covariate with truncation
...
setwd("C:/Users/owner/Dropbox/WORK/Zucker/Malka CIF/New Normal Simulations Second Round")
#setwd("D:/Dropbox/WORK/Zucker/Malka CIF/New Normal Simulations Second Round")
library(survival)
library(truncnorm)
#library(audio)
...
cif.setup = function(t.o,delta.o,z.o,wts.o) {
  ...
  rr.o1 = exp(beta1.hat*z.o)
  rr.o2 = exp(beta2.hat*z.o)
  wrr.o1 = wts.o*rr.o1
  wrr.o2 = wts.o*rr.o2
...
#CIF CURVE ESTIMATES
cif = function(t.o,delta.o,cif.set,znew) {
  ...
  type1 = (delta.o==1)
  type2 = (delta.o==2)
  thz1 = exp(cif.set$beta1.hat*znew)
  thz2 = exp(cif.set$beta2.hat*znew) 
...
n1 = round(1.25*n) + round(1.25*n.outsam)
...
#z = runif(n1) - 0.5
z = rtruncnorm(n1,a=-5,b=5,mean=0,sd=2)
rr1 = exp(beta1*z)
rr2 = exp(beta2*z)
...
for (i in 1:n.outsam) {
  rr1.zi = exp(beta1*z.outsam[i])
  rr2.zi = exp(beta2*z.outsam[i])
  t.old = 0
  for (r in 2:ngrid) {
    tcur = tgrid[r]
...
wts.o = rep(1,n)
cif.set.orig = cif.setup(t.o,delta.o,z.o,wts.o)
...
if (!coxcrash1) {
  ...
  cif.orig = cif(t.o,delta.o,cif.set.orig,znew)   
  ...
  for (i in 1:n.outsam) {
    zcur = z.outsam[i]
    cif.cur = cif(t.o,delta.o,cif.set.orig,zcur)
  ...
  for (ib in 1:nboot) {
    ...
    cif.set.boot = cif.setup(t.o,delta.o,z.o,wts.o)
    cif.boot = cif(t.o,delta.o,cif.set.boot,znew)
...
our.output6 = cbind(scenario,type,n,rr,censoring,nrep,f1b.pe.dif.max,f1c.pe.dif.max,f1.pe.dif.max,
...
if (outflg) {
  ...
  if (!censoring) {write(our.output5, file = "eee.txt", ncolumns=16, append=T, sep="     ")}
...
# pth = "D:/Dropbox/WORK/Zucker/Malka CIF/New Normal Simulations/"
pth = "C:/Users/owner/Dropbox/WORK/Zucker/Malka CIF/New Normal Simulations Second Round/"
