...
dat$delta <- dat$correct+1 #delta=1=correct, delta=2=incorrect
...
dat$order2 <- dat$order^2


ord <- 2
z = cbind(dat$order, dat$order2 , dat$age ,dat$sex  ,dat$yoe )
znew = c(ord , ord^2,  46 , 0  ,0 ) 
...
## The proposed approach - Method 3
